...
class SendEmailToTaskOwnerIfTaskCompletedOnTaskHasBeenUpdatedEventHandler implements EventUseCaseInterface
{
    private $commandBus;
    private $email;
    private $queryBus;
    ...
    public function __invoke(TaskHasBeenUpdateEvent $event): void
    {
        try {
            ...
            $this->commandBus->handle(new SendEmail(
                ...
                SendEmail::TYPE_TASK_HAS_BEEN_COMPLETED,
                $this->email,
                [$user->getEmail()],
                SendEmail::SUBJECT_TASK_HAS_BEEN_COMPLETED,
